...
@section('contenido')
        <h1 class="align-text-center">Agregar Prestamo</h1>
...
<form method="POST" action="{{ route('prestamos.store') }}">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control
               ...
               is-invalid
               @enderror
               " id="fecha_prestamo" name="fecha_prestamo" value = "{{old('fecha_prestamo')}}">
               @error('fecha_prestamo')
               <div class="invalid-feedback">{{ $message }}</div>
              @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control
               ...
               is-invalid
               @enderror
               "id="fecha_devolucion" name="fecha_devolucion" value = "{{old('fecha_devolucion')}}" >
               @error('fecha_devolucion')
               <div class="invalid-feedback">{{ $message }}</div>
               @enderror
    </div>
